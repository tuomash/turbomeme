...
public final class MemeImage implements Constants, Comparable<MemeImage>
{
	...
	public void validate()
	{
		...
		Preconditions.checkArgument(width <= MAX_IMAGE_WIDTH,
				"Width has to be equal or smaller than " + MAX_IMAGE_WIDTH + "! " +
		...
		Preconditions.checkArgument(!wwwPath.isEmpty(),
				"WWW path cannot be empty!");
	}
