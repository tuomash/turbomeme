...
public final class GetMemeServlet extends HttpServlet implements Constants
{
  ...
  public void init(final ServletConfig config) throws ServletException
  {
    ...
    configuration.setServletContextForTemplateLoading(config.getServletContext(), "/WEB-INF/classes/");
  ...
  private void process(final String pathInfo, final HttpServletResponse response) throws InvalidInputException, IOException, TemplateException
  {
    if (pathInfo == null)
    {
